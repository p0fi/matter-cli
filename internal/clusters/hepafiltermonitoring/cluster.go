...
func init() {
	clusters.Global.Register(clusters.ClusterInfo{
		...
		Attributes: []clusters.AttributeInfo{
			...
			{ID: AttrDegradationDirection, Name: "DegradationDirection", DisplayName: "DegradationDirection", Type: "enum8", Readable: true, Optional: true},
			{ID: AttrChangeIndication, Name: "ChangeIndication", DisplayName: "ChangeIndication", Type: "enum8", Readable: true},
			{ID: AttrInPlaceIndicator, Name: "InPlaceIndicator", DisplayName: "InPlaceIndicator", Type: "bool", Readable: true, Optional: true},
			{ID: AttrLastChangedTime, Name: "LastChangedTime", DisplayName: "LastChangedTime", Type: "uint32", Readable: true, Writable: true, Nullable: true, Optional: true},
			{ID: AttrReplacementProductList, Name: "ReplacementProductList", DisplayName: "ReplacementProductList", Type: "list", Readable: true, Optional: true},
		},
