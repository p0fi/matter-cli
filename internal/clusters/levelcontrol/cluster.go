...
const (
	FeatureOnOff     uint32 = 1 << 0 // OO
	FeatureLighting  uint32 = 1 << 1 // LT
	FeatureFrequency uint32 = 1 << 2 // FQ
)
...
const (
	...
	CmdMoveToClosestFrequency uint32 = 0x08
)
...
// MoveToClosestFrequencyRequest is the request payload for the MoveToClosestFrequency command.
type MoveToClosestFrequencyRequest struct {
	Frequency uint16 `tlv:"0,uint"`
}
...
func init() {
	clusters.Global.Register(clusters.ClusterInfo{
		...
		Features: []clusters.FeatureInfo{
			{Bit: 0, Code: "OO", Name: "OnOff"},
			{Bit: 1, Code: "LT", Name: "Lighting"},
			{Bit: 2, Code: "FQ", Name: "Frequency"},
		},
		Attributes: []clusters.AttributeInfo{
			...
			{ID: AttrMinLevel, Name: "MinLevel", DisplayName: "MinLevel", Type: "uint8", Readable: true},
			{ID: AttrMaxLevel, Name: "MaxLevel", DisplayName: "MaxLevel", Type: "uint8", Readable: true},
			{ID: AttrCurrentFrequency, Name: "CurrentFrequency", DisplayName: "CurrentFrequency", Type: "uint16", Readable: true},
			{ID: AttrMinFrequency, Name: "MinFrequency", DisplayName: "MinFrequency", Type: "uint16", Readable: true},
			{ID: AttrMaxFrequency, Name: "MaxFrequency", DisplayName: "MaxFrequency", Type: "uint16", Readable: true},
			{ID: AttrOptions, Name: "Options", DisplayName: "Options", Type: "bitmap8", Readable: true, Writable: true},
			{ID: AttrOnOffTransitionTime, Name: "OnOffTransitionTime", DisplayName: "OnOffTransitionTime", Type: "uint16", Readable: true, Writable: true},
			{ID: AttrOnLevel, Name: "OnLevel", DisplayName: "OnLevel", Type: "uint8", Readable: true, Writable: true, Nullable: true},
			{ID: AttrOnTransitionTime, Name: "OnTransitionTime", DisplayName: "OnTransitionTime", Type: "uint16", Readable: true, Writable: true, Nullable: true},
			{ID: AttrOffTransitionTime, Name: "OffTransitionTime", DisplayName: "OffTransitionTime", Type: "uint16", Readable: true, Writable: true, Nullable: true},
			{ID: AttrDefaultMoveRate, Name: "DefaultMoveRate", DisplayName: "DefaultMoveRate", Type: "uint8", Readable: true, Writable: true, Nullable: true},
		...
		Commands: []clusters.CommandInfo{
			...
			{ID: CmdMoveToLevelWithOnOff, Name: "MoveToLevelWithOnOff", DisplayName: "MoveToLevelWithOnOff"},
			{ID: CmdMoveWithOnOff, Name: "MoveWithOnOff", DisplayName: "MoveWithOnOff"},
			{ID: CmdStepWithOnOff, Name: "StepWithOnOff", DisplayName: "StepWithOnOff"},
			{ID: CmdStopWithOnOff, Name: "StopWithOnOff", DisplayName: "StopWithOnOff"},
			{ID: CmdMoveToClosestFrequency, Name: "MoveToClosestFrequency", DisplayName: "MoveToClosestFrequency", HasRequest: true, RequestFields: []clusters.CommandFieldInfo{
				{ID: 0, Name: "Frequency", DisplayName: "Frequency", Type: "uint16"},
			}},
		},
	})
}
